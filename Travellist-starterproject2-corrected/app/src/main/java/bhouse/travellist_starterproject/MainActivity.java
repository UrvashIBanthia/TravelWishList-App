...
public class MainActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    TravelListAdapter.OnItemClickListener onItemClickListener=
      ...
      public void onItemClick(View view, int position) {
        ...
        Pair<View, String> navPair=Pair.create(navigationBar,getWindow().NAVIGATION_BAR_BACKGROUND_TRANSITION_NAME);
        Pair<View,String> statusPair=Pair.create(statusBar,getWindow().STATUS_BAR_BACKGROUND_TRANSITION_NAME);
